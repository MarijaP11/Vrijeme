...
def zagreb():
        ...
        apikey = "e044d71c7415c32a8ed3aab211f8517c"

        url = "https://api.openweathermap.org/data/2.5/weather?q={0}&units={1}&appid={2}&lang=hr".format(grad, unit,
                                                                                                         apikey)
...
def rijeka():
    ...
    apikey = "b6a204b029895fb21e418bb7459302bd"
